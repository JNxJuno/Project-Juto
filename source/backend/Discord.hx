...
class DiscordClient
{
    ...
    // ✨ TIPP: Wenn du ein eigenes Logo in Discord willst, musst du im Discord Developer Portal
    // eine App erstellen und diese ID hier eintragen:
    private inline static final _defaultID:String = "1487864363040772338"; 
    ...
    public static function changePresence(details:String = 'In the Menus', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
    {
        ...
        // ✨ HIER WURDE GEZAUBERT: Der Name deiner Mod erscheint jetzt beim Hovern über das Bild!
        presence.largeImageText = 'Project Juto'; 
