...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		psychVer.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.WHITE, RIGHT, flixel.text.FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		fnfVer.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.WHITE, LEFT, flixel.text.FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		// ✨ DIE ANZEIGE WIRD JETZT GANZ AM ENDE GELADEN
		var globalMusic = new mikolka.vslice.ui.GlobalNowPlaying();
		add(globalMusic);
	}
	...
	function goToOptions()
	{
		...
		if (PlayState.SONG != null)
		{
			...
			#if !LEGACY_PSYCH PlayState.stageUI = 'normal';
			#end
		}
	}
